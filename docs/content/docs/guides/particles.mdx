...
```bash
# Spawn default white smoke
/particle hytale:particles.smoke

# Large red particles (scale 2.0, RGB 255,0,0)
/particle hytale:particles.smoke 2.0 255 0 0

# Blue particles (scale 1.5, RGB 0,100,255)
/particle hytale:particles.smoke 1.5 0 100 255

# Purple particles (RGB 200,0,200)
/particle hytale:particles.smoke 1.0 200 0 200
```
