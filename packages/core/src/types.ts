...
export interface PlayerRef {
  ...
  getTransform(): Transform;
  getWorldUuid(): { toString(): string } | null;
...
export interface EntityStatType {
  ...
  new (
    ...
    max: number,
    shared: boolean,
    regenerating: unknown[] | null,
    minValueEffects: unknown,
    maxValueEffects: unknown,
    entityStatResetBehavior: unknown,
  ): EntityStatType;
  getAssetStore(): unknown;
  getAssetMap(): unknown;
...
export interface InteractionChain {
  ...
  new (
    forkedChainId: unknown | null,
    baseForkedChainId: unknown | null,
    type: unknown,
    context: unknown,
    chainData: unknown,
    rootInteraction: unknown,
    onCompletion: unknown | null,
...
export interface ItemPrePhysicsSystem {
  new (
    ...
    boundingBoxComponentType: unknown,
    velocityComponentType: unknown,
    transformComponentType: unknown,
    physicsValuesComponentType: unknown,
...
export interface Particle {
  new (
    ...
    frameSize: unknown,
    uvOption: unknown,
    scaleRatioConstraint: unknown,
    softParticle: unknown,
    softParticlesFadeFactor: number,
    useSpriteBlending: boolean,
    initialAnimationFrame: unknown,
    collisionAnimationFrame: unknown,
    animation: unknown,
  ): Particle;
  getTexture(): string;
...
export interface ParticleAttractor {
  new (
    position: unknown,
    radialAxis: unknown,
    trailPositionMultiplier: number,
    radius: number,
    radialAcceleration: number,
    radialTangentAcceleration: number,
    linearAcceleration: unknown,
    radialImpulse: number,
    radialTangentImpulse: number,
    linearImpulse: unknown,
    dampingMultiplier: unknown,
  ): ParticleAttractor;
  getPosition(): unknown;
...
export interface ParticleSpawner {
  new (
    ...
    shape: unknown,
    emitOffset: unknown,
    useEmitDirection: boolean,
    cameraOffset: number,
    particleRotationInfluence: unknown,
    particleRotateWithSpawner: boolean,
    isLowRes: boolean,
    trailSpawnerPositionMultiplier: number,
    trailSpawnerRotationMultiplier: number,
    ...
    velocityStretchMultiplier: number,
    uvMotion: unknown,
    attractors: unknown[],
...
export interface PlayerSkin {
  ...
  new (
    bodyCharacteristic: PlayerSkinPartId,
    underwear: PlayerSkinPartId,
    face: string,
    ears: string,
    mouth: string,
    eyes: PlayerSkinPartId | null,
    facialHair: PlayerSkinPartId | null,
    haircut: PlayerSkinPartId | null,
    eyebrows: PlayerSkinPartId | null,
    pants: PlayerSkinPartId | null,
    overpants: PlayerSkinPartId | null,
    undertop: PlayerSkinPartId | null,
    overtop: PlayerSkinPartId | null,
    shoes: PlayerSkinPartId | null,
    headAccessory: PlayerSkinPartId | null,
    faceAccessory: PlayerSkinPartId | null,
    earAccessory: PlayerSkinPartId | null,
    skinFeature: PlayerSkinPartId | null,
    gloves: PlayerSkinPartId | null,
    cape: PlayerSkinPartId | null,
  ): PlayerSkin;
  new (
...
export interface BlockPlaceUtils {
  placeBlock(
    ...
    placementNormal: unknown,
    blockPosition: unknown,
    blockRotation: unknown,
    inventory: unknown,
    activeSlot: number,
    removeItemInHand: boolean,
    chunkReference: unknown,
    chunkStore: unknown,
    entityStore: unknown,
  ): void;
...
export interface EntityStore {
  ...
  getRefFromUUID(uuid: { toString(): string }): Ref<EntityStore> | null;
...
export interface EventData {
  ...
  append<T extends string>(key: string, enumValue: { name(): T }): EventData;
...
// ScriptCustomUIPage - HytaleJS helper for creating custom UI pages from TypeScript
...
export interface ScriptCustomUIPageStatic {
  ...
  new (
    playerRef: PlayerRef,
    lifetime: CustomPageLifetime,
    buildCallback: ScriptCustomUIPageBuildCallback,
    eventCallback: ScriptCustomUIPageEventCallback | null,
  ): ScriptCustomUIPage;
  new (
    playerRef: PlayerRef,
    lifetime: CustomPageLifetime,
    buildCallback: ScriptCustomUIPageBuildCallback,
    eventCallback: ScriptCustomUIPageEventCallback | null,
    dismissCallback: ScriptCustomUIPageDismissCallback | null,
  ): ScriptCustomUIPage;
}
...
export interface NPCPlugin {
  ...
  spawnEntity(
    ...
    spawnModel: Model | null,
    postSpawn: TriConsumer<NPCEntity, Ref<EntityStore>, Store<EntityStore>> | null,
  ): JavaPair<Ref<EntityStore>, NPCEntity> | null;
...
export interface FlockPlugin {
  ...
  trySpawnFlock(
    ...
    npcComponent: NPCEntity,
    store: Store<EntityStore>,
    roleIndex: number,
    position: Vector3d,
    rotation: Vector3f,
    flockDefinition: FlockAsset | null,
    postSpawn: TriConsumer<NPCEntity, Ref<EntityStore>, Store<EntityStore>> | null,
  ): void;
}
